...
namespace ProjetFinal__6235923.Data;
...
public partial class ConcessionaireMercedesContext : DbContext
{
    ...
    public virtual DbSet<VwStatsCategorie> VueStatsCategories { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__changelo__3213E83F306BD707");
        ...
        modelBuilder.Entity<VwStatsCategorie>(entity =>
        {
